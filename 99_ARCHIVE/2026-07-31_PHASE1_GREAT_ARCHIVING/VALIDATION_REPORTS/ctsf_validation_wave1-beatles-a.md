...
**Generated:** 2026-04-24T09:10:25
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 47 / 6252 — **0.75%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6201 / 6252 — 99.18%
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 688 | 5564 | 11.0% |
| `REC_chapters` | recommended field 'chapters' populated | 47 | 6205 | 0.8% |
...
| `REC_form` | recommended field 'form' populated | 48 | 6204 | 0.8% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 47 | 6205 | 0.8% |
| `REC_tags` | recommended field 'tags' populated | 48 | 6204 | 0.8% |
| `REC_tempo` | recommended field 'tempo' populated | 47 | 6205 | 0.8% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 47 | 6205 | 0.8% |
...
- THE_BEATLES - A_DAY_IN_THE_LIFE.md — form values without Timeline header: ['bridge', 'interlude']
