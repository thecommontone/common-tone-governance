...
**Generated:** 2026-04-24T09:57:31
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 74 / 6252 — **1.18%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6175 / 6252 — 98.77%
...
| `REC_chapters` | recommended field 'chapters' populated | 73 | 6179 | 1.2% |
...
| `REC_form` | recommended field 'form' populated | 74 | 6178 | 1.2% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 73 | 6179 | 1.2% |
| `REC_tags` | recommended field 'tags' populated | 74 | 6178 | 1.2% |
| `REC_tempo` | recommended field 'tempo' populated | 73 | 6179 | 1.2% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 73 | 6179 | 1.2% |
