...
| Tier | Files | Meaning |
|---|---:|---|
| `strict` | 6232 | YAML parsed cleanly on first try |
...
|---|---:|---|
| `filename` | 15 | clean 'Artist - Title' filename — trusted |
...
- Files keeping current filename: **15**
...
|---|---:|---:|
| `album` | 15 | 100.0% |
| `legacy_source` | 15 | 100.0% |
| `legacy_tempo_bpm` | 15 | 100.0% |
