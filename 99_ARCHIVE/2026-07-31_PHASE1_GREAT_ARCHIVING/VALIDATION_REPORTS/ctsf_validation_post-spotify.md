...
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 5951 / 6116 — 97.30%
- **Failed** (at least one Required rule fails): 3 / 6116 — 0.05%

- Schema-compliant (enriched + skeleton): 6113 / 6116 (99.95%)
...
|---|---|---:|---:|---:|
| `R01` | ct_format field present in frontmatter | 6113 | 3 | 100.0% |
| `R02` | required fields present (song, artist, year, tonic, mode, meter) | 6113 | 3 | 100.0% |
| `R03` | tonic is letter name (A-G with optional ♭/♯) or `unknown` | 6113 | 3 | 100.0% |
| `R04` | mode is valid value, lowercase, or `unknown` | 6113 | 3 | 100.0% |
| `R05` | Timeline uses ♭/♯ not ASCII b/# | 6116 | 0 | 100.0% |
| `R07` | section headers well-formed (brackets optional) | 6116 | 0 | 100.0% |
| `R08` | filename follows §1.1 CTSF convention | 6113 | 3 | 100.0% |
...
| `R_BODY` | all required body sections present | 6113 | 3 | 100.0% |
...
| `REC_chapters` | recommended field 'chapters' populated | 258 | 5858 | 4.2% |
| `REC_ct_entry_date` | recommended field 'ct_entry_date' populated | 6113 | 3 | 100.0% |
| `REC_ct_last_updated` | recommended field 'ct_last_updated' populated | 6113 | 3 | 100.0% |
