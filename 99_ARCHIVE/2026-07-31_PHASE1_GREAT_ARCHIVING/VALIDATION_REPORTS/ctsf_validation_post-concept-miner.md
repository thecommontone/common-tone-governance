...
**Generated:** 2026-04-24T16:02:58
**Source folder:** `/sessions/gallant-optimistic-gauss/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6251

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 74 / 6251 — **1.18%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6174 / 6251 — 98.77%
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 692 | 5559 | 11.1% |
| `REC_chapters` | recommended field 'chapters' populated | 229 | 6022 | 3.7% |
...
| `REC_form` | recommended field 'form' populated | 74 | 6177 | 1.2% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 73 | 6178 | 1.2% |
| `REC_tags` | recommended field 'tags' populated | 74 | 6177 | 1.2% |
| `REC_tempo` | recommended field 'tempo' populated | 73 | 6178 | 1.2% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 73 | 6178 | 1.2% |
