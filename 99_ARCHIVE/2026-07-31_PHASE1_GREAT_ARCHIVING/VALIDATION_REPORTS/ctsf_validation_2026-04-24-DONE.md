...
- AL_GREEN - IM_STILL_IN_LOVE_WITH_YOU.md — form values without Timeline header: ['verse', 'bridge', 'chorus', 'chorus-out', 'intro']
- AL_GREEN - TAKE_ME_TO_THE_RIVER.md — form values without Timeline header: ['verse', 'bridge', 'chorus', 'chorus-out', 'pre-chorus']
- ANDRAE_CROUCH - THROUGH_IT_ALL.md — form values without Timeline header: ['verse', 'chorus']
- BILL_WITHERS - USE_ME.md — form values without Timeline header: ['verse', 'bridge', 'chorus', 'chorus-out', 'intro']
- CURTIS_MAYFIELD - MOVE_ON_UP.md — form values without Timeline header: ['verse', 'chorus', 'instrumental-break', 'chorus-out', 'intro']
