...
**Generated:** 2026-04-24T16:26:38
**Source folder:** `/sessions/gallant-optimistic-gauss/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 123 / 6252 — **1.97%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6126 / 6252 — 97.98%
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 697 | 5555 | 11.1% |
| `REC_chapters` | recommended field 'chapters' populated | 235 | 6017 | 3.8% |
...
| `REC_form` | recommended field 'form' populated | 123 | 6129 | 2.0% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 122 | 6130 | 2.0% |
| `REC_tags` | recommended field 'tags' populated | 123 | 6129 | 2.0% |
| `REC_tempo` | recommended field 'tempo' populated | 122 | 6130 | 2.0% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 122 | 6130 | 2.0% |
