...
**Generated:** 2026-04-24T09:41:31
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 62 / 6252 — **0.99%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6187 / 6252 — 98.96%
...
| `REC_chapters` | recommended field 'chapters' populated | 61 | 6191 | 1.0% |
...
| `REC_form` | recommended field 'form' populated | 62 | 6190 | 1.0% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 61 | 6191 | 1.0% |
| `REC_tags` | recommended field 'tags' populated | 62 | 6190 | 1.0% |
| `REC_tempo` | recommended field 'tempo' populated | 61 | 6191 | 1.0% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 61 | 6191 | 1.0% |
