...
**Generated:** 2026-04-24T19:55:51
**Source folder:** `02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6005

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 211 / 6005 — **3.51%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 5794 / 6005 — 96.49%
- **Failed** (at least one Required rule fails): 0 / 6005 — 0.00%

- Schema-compliant (enriched + skeleton): 6005 / 6005 (100.00%)
...
| `R14` | every form value maps to a Timeline header (suffix-stripped) | 6005 | 0 | 100.0% |
