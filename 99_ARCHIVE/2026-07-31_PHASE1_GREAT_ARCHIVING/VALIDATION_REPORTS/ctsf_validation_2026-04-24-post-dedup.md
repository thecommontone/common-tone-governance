...
**Generated:** 2026-04-24T12:36:12
**Source folder:** `/Users/dougsmith/Docs/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6005

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 162 / 6005 — **2.70%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 5843 / 6005 — 97.30%
...
| `REC_chapters` | recommended field 'chapters' populated | 286 | 5719 | 4.8% |
...
| `REC_form` | recommended field 'form' populated | 162 | 5843 | 2.7% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 161 | 5844 | 2.7% |
| `REC_tags` | recommended field 'tags' populated | 162 | 5843 | 2.7% |
| `REC_tempo` | recommended field 'tempo' populated | 161 | 5844 | 2.7% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 161 | 5844 | 2.7% |
