...
**Generated:** 2026-04-24T19:53:40
**Source folder:** `/sessions/gifted-sweet-galileo/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6005

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 204 / 6005 — **3.40%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 5794 / 6005 — 96.49%
- **Failed** (at least one Required rule fails): 7 / 6005 — 0.12%

- Schema-compliant (enriched + skeleton): 5998 / 6005 (99.88%)
...
| `R14` | every form value maps to a Timeline header (suffix-stripped) | 5998 | 7 | 99.9% |
...
| `REC_chapters` | recommended field 'chapters' populated | 335 | 5670 | 5.6% |
...
| `REC_form` | recommended field 'form' populated | 212 | 5793 | 3.5% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 211 | 5794 | 3.5% |
| `REC_tags` | recommended field 'tags' populated | 212 | 5793 | 3.5% |
| `REC_tempo` | recommended field 'tempo' populated | 211 | 5794 | 3.5% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 211 | 5794 | 3.5% |
...
- JAMES_SCOTT - GRACE_AND_BEAUTY.md — form values without Timeline header: ['intro', 'strain-a', 'strain-b', 'strain-c', 'strain-d']
- ORIGINAL_DIXIELAND_JASS_BAND - LIVERY_STABLE_BLUES.md — form values without Timeline header: ['chorus', 'intro', 'tag']

## Most common failure patterns

| Rank | Failing rules | # files |
|---:|---|---:|
| 1 | (fully compliant) | 5998 |
| 2 | R14 | 7 |
