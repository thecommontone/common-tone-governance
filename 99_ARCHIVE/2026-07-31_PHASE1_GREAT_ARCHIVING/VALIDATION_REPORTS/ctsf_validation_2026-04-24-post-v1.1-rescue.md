...
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6034 / 6366 — 94.78%
- **Failed** (at least one Required rule fails): 316 / 6366 — 4.96%

- Schema-compliant (enriched + skeleton): 6050 / 6366 (95.04%)
...
| `R04` | mode is valid value, lowercase, or `unknown` | 6202 | 164 | 97.4% |
| `R05` | Timeline uses ♭/♯ not ASCII b/# | 6358 | 8 | 99.9% |
| `R07` | section headers well-formed (brackets optional) | 6366 | 0 | 100.0% |
| `R08` | filename follows §1.1 CTSF convention | 6069 | 297 | 95.3% |
...
- ANTONIO_CARLOS_JOBIM - HOW_INSENSITIVE.md — mode='aeolian' not in valid mode table
...
- AEROSMITH - CRYIN_2.md — expected 'AEROSMITH - CRYIN.md'
- ALABAMA - MOUNTAIN_MUSIC_2.md — expected 'ALABAMA - MOUNTAIN_MUSIC.md'
- ALLMAN_BROTHERS_BAND - JESSICA_2.md — expected 'ALLMAN_BROTHERS_BAND - JESSICA.md'

### `R14` — every form value maps to a Timeline header (suffix-stripped)

- AL_GREEN - IM_STILL_IN_LOVE_WITH_YOU.md — form values without Timeline header: ['chorus-out', 'bridge', 'verse', 'chorus', 'intro']
- AL_GREEN - TAKE_ME_TO_THE_RIVER.md — form values without Timeline header: ['chorus-out', 'bridge', 'verse', 'chorus', 'pre-chorus']
- ANDRAE_CROUCH - THROUGH_IT_ALL.md — form values without Timeline header: ['verse', 'chorus']
- BILL_WITHERS - USE_ME.md — form values without Timeline header: ['chorus-out', 'bridge', 'verse', 'chorus', 'intro']
- CURTIS_MAYFIELD - MOVE_ON_UP.md — form values without Timeline header: ['chorus-out', 'instrumental-break', 'verse', 'chorus', 'intro']
...
|---:|---|---:|
| 1 | (fully compliant) | 6050 |
| 2 | R08 | 133 |
| 3 | R01, R02, R03, R04, R08, R_BODY, R_TITLE | 98 |
| 4 | R01, R02, R03, R04, R08, R_BODY | 64 |
| 5 | R05, R14 | 8 |
| 6 | R14 | 4 |
| 7 | R_BODY | 4 |
| 8 | R04, R_BODY | 2 |
