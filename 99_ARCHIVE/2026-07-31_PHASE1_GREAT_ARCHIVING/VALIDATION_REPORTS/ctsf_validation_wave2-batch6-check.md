...
**Generated:** 2026-04-24T17:10:53
**Source folder:** `02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6250

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 172 / 6250 — **2.75%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6075 / 6250 — 97.20%
- **Failed** (at least one Required rule fails): 3 / 6250 — 0.05%

- Schema-compliant (enriched + skeleton): 6247 / 6250 (99.95%)
...
|---|---|---:|---:|---:|
| `R01` | ct_format field present in frontmatter | 6247 | 3 | 100.0% |
| `R02` | required fields present (song, artist, year, tonic, mode, meter) | 6247 | 3 | 100.0% |
| `R03` | tonic is letter name (A-G with optional ♭/♯) or `unknown` | 6247 | 3 | 100.0% |
| `R04` | mode is valid value, lowercase, or `unknown` | 6247 | 3 | 100.0% |
| `R05` | Timeline uses ♭/♯ not ASCII b/# | 6250 | 0 | 100.0% |
| `R07` | section headers well-formed (brackets optional) | 6250 | 0 | 100.0% |
| `R08` | filename follows §1.1 CTSF convention | 6247 | 3 | 100.0% |
...
| `R_BODY` | all required body sections present | 6247 | 3 | 100.0% |
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 702 | 5548 | 11.2% |
| `REC_chapters` | recommended field 'chapters' populated | 278 | 5972 | 4.4% |
| `REC_ct_entry_date` | recommended field 'ct_entry_date' populated | 6247 | 3 | 100.0% |
| `REC_ct_last_updated` | recommended field 'ct_last_updated' populated | 6247 | 3 | 100.0% |
| `REC_form` | recommended field 'form' populated | 172 | 6078 | 2.8% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 171 | 6079 | 2.7% |
| `REC_tags` | recommended field 'tags' populated | 172 | 6078 | 2.8% |
| `REC_tempo` | recommended field 'tempo' populated | 171 | 6079 | 2.7% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 171 | 6079 | 2.7% |
