...
**Generated:** 2026-04-24T08:55:11
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 38 / 6252 — **0.61%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6211 / 6252 — 99.34%
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 687 | 5565 | 11.0% |
| `REC_chapters` | recommended field 'chapters' populated | 37 | 6215 | 0.6% |
...
| `REC_form` | recommended field 'form' populated | 38 | 6214 | 0.6% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 37 | 6215 | 0.6% |
| `REC_tags` | recommended field 'tags' populated | 38 | 6214 | 0.6% |
| `REC_tempo` | recommended field 'tempo' populated | 37 | 6215 | 0.6% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 37 | 6215 | 0.6% |
