...
**Generated:** 2026-04-24T16:21:49
**Source folder:** `02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 119 / 6252 — **1.90%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6130 / 6252 — 98.05%
...
| `REC_chapters` | recommended field 'chapters' populated | 232 | 6020 | 3.7% |
...
| `REC_form` | recommended field 'form' populated | 119 | 6133 | 1.9% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 118 | 6134 | 1.9% |
| `REC_tags` | recommended field 'tags' populated | 119 | 6133 | 1.9% |
| `REC_tempo` | recommended field 'tempo' populated | 118 | 6134 | 1.9% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 118 | 6134 | 1.9% |
