...
**Source:** `/sessions/amazing-loving-gates/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Total files seen:** 6359
**Will migrate:** 6108
**Will skip:** 56
**Needs human review:** 195
...
| target filename empty after normalization | 1 |
...
- `A Horse With No Name.md` — cannot determine artist+song from frontmatter or filename

## Renames

- Files keeping current filename: **1**
- Files being renamed:            **6107**
...
| `- Song Name.md` | `SADE - SMOOTH_OPERATOR_SINGLE_VERSION.md` |
...
|---|---:|---:|
| `legacy_source` | 1614 | 26.4% |
| `spotify_link` | 1408 | 23.1% |
| `composers` | 953 | 15.6% |
| `album` | 386 | 6.3% |
| `legacy_tempo_bpm` | 277 | 4.5% |
| `genre` | 148 | 2.4% |
| `legacy_key` | 68 | 1.1% |
