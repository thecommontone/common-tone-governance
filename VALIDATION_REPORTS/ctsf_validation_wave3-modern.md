...
**Generated:** 2026-04-24T09:55:21
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6250

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 74 / 6250 — **1.18%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6173 / 6250 — 98.77%
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 692 | 5558 | 11.1% |
| `REC_chapters` | recommended field 'chapters' populated | 73 | 6177 | 1.2% |
...
| `REC_form` | recommended field 'form' populated | 74 | 6176 | 1.2% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 73 | 6177 | 1.2% |
| `REC_tags` | recommended field 'tags' populated | 74 | 6176 | 1.2% |
| `REC_tempo` | recommended field 'tempo' populated | 73 | 6177 | 1.2% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 73 | 6177 | 1.2% |
