...
**Generated:** 2026-04-24T07:33:27
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6229

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 36 / 6229 — **0.58%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6182 / 6229 — 99.25%
- **Failed** (at least one Required rule fails): 11 / 6229 — 0.18%

- Schema-compliant (enriched + skeleton): 6218 / 6229 (99.82%)
- Frontmatter parseable: 6229 / 6229 (100.0%)

## Required Rules — pass/fail breakdown

| Rule | Name | Pass | Fail | Pass % |
|---|---|---:|---:|---:|
| `R01` | ct_format field present in frontmatter | 6219 | 10 | 99.8% |
| `R02` | required fields present (song, artist, year, tonic, mode, meter) | 6219 | 10 | 99.8% |
| `R03` | tonic is letter name (A-G with optional ♭/♯) or `unknown` | 6219 | 10 | 99.8% |
| `R04` | mode is valid value, lowercase, or `unknown` | 6219 | 10 | 99.8% |
| `R05` | Timeline uses ♭/♯ not ASCII b/# | 6229 | 0 | 100.0% |
| `R07` | section headers well-formed (brackets optional) | 6229 | 0 | 100.0% |
| `R08` | filename follows §1.1 CTSF convention | 6219 | 10 | 99.8% |
| `R14` | every form value maps to a Timeline header (suffix-stripped) | 6228 | 1 | 100.0% |
| `R15` | tempo field value is a quoted string | 6229 | 0 | 100.0% |
| `R16` | mode-change separator uses ' / ' (lowercase mode) | 6229 | 0 | 100.0% |
| `R_BODY` | all required body sections present | 6219 | 10 | 99.8% |
| `R_TITLE` | # Title heading present | 6229 | 0 | 100.0% |

## Recommended Rules — pass/fail breakdown

| Rule | Field | Populated | Empty | Pass % |
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 656 | 5573 | 10.5% |
| `REC_chapters` | recommended field 'chapters' populated | 36 | 6193 | 0.6% |
| `REC_ct_entry_date` | recommended field 'ct_entry_date' populated | 6219 | 10 | 99.8% |
| `REC_ct_last_updated` | recommended field 'ct_last_updated' populated | 6219 | 10 | 99.8% |
| `REC_form` | recommended field 'form' populated | 37 | 6192 | 0.6% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 36 | 6193 | 0.6% |
| `REC_tags` | recommended field 'tags' populated | 37 | 6192 | 0.6% |
| `REC_tempo` | recommended field 'tempo' populated | 36 | 6193 | 0.6% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 36 | 6193 | 0.6% |
...
- MADONNA - LIKE_A_VIRGIN.md — ct_format missing (found: ['album', 'artist', 'date_ingested', 'ingested', 'key_note', 'meter']...)
...
- MADONNA - LIKE_A_VIRGIN.md — missing: ct_format,song,tonic
...
- MADONNA - LIKE_A_VIRGIN.md — tonic empty/missing
...
- MADONNA - LIKE_A_VIRGIN.md — mode='Major' not in valid mode table
...
- MADONNA - LIKE_A_VIRGIN.md — cannot check — song/artist missing

### `R14` — every form value maps to a Timeline header (suffix-stripped)

- THE_CHI_LITES - HAVE_YOU_SEEN_HER.md — form values without Timeline header: ['verse-2-spoken', 'verse-spoken']
...
- MADONNA - LIKE_A_VIRGIN.md — missing sections: Summary,Timeline,Chord Vocabulary,Theoretical Notes,Connections
...
| 2 | R01, R02, R03, R04, R08, R_BODY | 10 |
| 3 | R14 | 1 |
