...
**Generated:** 2026-04-24T09:17:32
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 50 / 6252 — **0.80%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6199 / 6252 — 99.15%
...
| `REC_chapters` | recommended field 'chapters' populated | 49 | 6203 | 0.8% |
...
| `REC_form` | recommended field 'form' populated | 50 | 6202 | 0.8% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 49 | 6203 | 0.8% |
| `REC_tags` | recommended field 'tags' populated | 50 | 6202 | 0.8% |
| `REC_tempo` | recommended field 'tempo' populated | 49 | 6203 | 0.8% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 49 | 6203 | 0.8% |
