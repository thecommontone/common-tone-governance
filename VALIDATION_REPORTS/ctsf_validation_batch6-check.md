...
**Generated:** 2026-04-24T09:22:11
**Source folder:** `/Users/dougsmith/Docs/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 122 / 6252 — **1.95%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6127 / 6252 — 98.00%
...
| `REC_form` | recommended field 'form' populated | 122 | 6130 | 2.0% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 121 | 6131 | 1.9% |
| `REC_tags` | recommended field 'tags' populated | 122 | 6130 | 2.0% |
| `REC_tempo` | recommended field 'tempo' populated | 121 | 6131 | 1.9% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 121 | 6131 | 1.9% |
