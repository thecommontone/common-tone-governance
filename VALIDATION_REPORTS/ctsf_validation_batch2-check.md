...
**Generated:** 2026-04-24T16:22:21
**Source folder:** `02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 121 / 6252 — **1.94%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6128 / 6252 — 98.02%
...
| `REC_form` | recommended field 'form' populated | 121 | 6131 | 1.9% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 120 | 6132 | 1.9% |
| `REC_tags` | recommended field 'tags' populated | 121 | 6131 | 1.9% |
| `REC_tempo` | recommended field 'tempo' populated | 120 | 6132 | 1.9% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 120 | 6132 | 1.9% |
