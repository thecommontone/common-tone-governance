...
**Generated:** 2026-04-24T08:31:26
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6251

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 37 / 6251 — **0.59%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6211 / 6251 — 99.36%
- **Failed** (at least one Required rule fails): 3 / 6251 — 0.05%

- Schema-compliant (enriched + skeleton): 6248 / 6251 (99.95%)
...
| `R14` | every form value maps to a Timeline header (suffix-stripped) | 6251 | 0 | 100.0% |
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 686 | 5565 | 11.0% |
| `REC_chapters` | recommended field 'chapters' populated | 36 | 6215 | 0.6% |
...
| `REC_form` | recommended field 'form' populated | 37 | 6214 | 0.6% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 36 | 6215 | 0.6% |
| `REC_tags` | recommended field 'tags' populated | 37 | 6214 | 0.6% |
| `REC_tempo` | recommended field 'tempo' populated | 36 | 6215 | 0.6% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 36 | 6215 | 0.6% |
