...
**Generated:** 2026-04-24T16:21:00
**Source folder:** `02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 115 / 6252 — **1.84%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6134 / 6252 — 98.11%
...
| `REC_chapters` | recommended field 'chapters' populated | 230 | 6022 | 3.7% |
...
| `REC_form` | recommended field 'form' populated | 115 | 6137 | 1.8% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 114 | 6138 | 1.8% |
| `REC_tags` | recommended field 'tags' populated | 115 | 6137 | 1.8% |
| `REC_tempo` | recommended field 'tempo' populated | 114 | 6138 | 1.8% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 114 | 6138 | 1.8% |
