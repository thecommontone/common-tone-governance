...
|---|---|---:|---:|---:|
| `R01` | ct_format field present in frontmatter | 6219 | 1 | 100.0% |
| `R02` | required fields present (song, artist, year, tonic, mode, meter) | 6219 | 1 | 100.0% |
| `R03` | tonic is letter name (A-G with optional ♭/♯) or `unknown` | 6219 | 1 | 100.0% |
| `R04` | mode is valid value, lowercase, or `unknown` | 6219 | 1 | 100.0% |
| `R05` | Timeline uses ♭/♯ not ASCII b/# | 6220 | 0 | 100.0% |
| `R07` | section headers well-formed (brackets optional) | 6220 | 0 | 100.0% |
| `R08` | filename follows §1.1 CTSF convention | 6219 | 1 | 100.0% |
...
| `R_BODY` | all required body sections present | 6219 | 1 | 100.0% |
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 645 | 5575 | 10.4% |
| `REC_chapters` | recommended field 'chapters' populated | 36 | 6184 | 0.6% |
| `REC_ct_entry_date` | recommended field 'ct_entry_date' populated | 6219 | 1 | 100.0% |
| `REC_ct_last_updated` | recommended field 'ct_last_updated' populated | 6219 | 1 | 100.0% |
...
- BARRY_MANILOW - COPACABANA.md — ct_format missing (found: ['album', 'artist', 'date_ingested', 'ingested', 'key_note', 'meter']...)

### `R02` — required fields present (song, artist, year, tonic, mode, meter)

- BARRY_MANILOW - COPACABANA.md — missing: ct_format,song,tonic

### `R03` — tonic is letter name (A-G with optional ♭/♯) or `unknown`

- BARRY_MANILOW - COPACABANA.md — tonic empty/missing

### `R04` — mode is valid value, lowercase, or `unknown`

- BARRY_MANILOW - COPACABANA.md — mode='Minor (with major-key lift)' not in valid mode table

### `R08` — filename follows §1.1 CTSF convention

- BARRY_MANILOW - COPACABANA.md — cannot check — song/artist missing

### `R14` — every form value maps to a Timeline header (suffix-stripped)

- AL_GREEN - IM_STILL_IN_LOVE_WITH_YOU.md — form values without Timeline header: ['intro', 'chorus', 'bridge', 'verse', 'chorus-out']
- AL_GREEN - TAKE_ME_TO_THE_RIVER.md — form values without Timeline header: ['intro', 'pre-chorus', 'chorus', 'bridge', 'verse']
- ANDRAE_CROUCH - THROUGH_IT_ALL.md — form values without Timeline header: ['verse', 'chorus']
- BILL_WITHERS - USE_ME.md — form values without Timeline header: ['intro', 'chorus', 'bridge', 'verse', 'chorus-out']
- CURTIS_MAYFIELD - MOVE_ON_UP.md — form values without Timeline header: ['instrumental-break', 'intro', 'chorus', 'verse', 'chorus-out']

### `R_BODY` — all required body sections present

- BARRY_MANILOW - COPACABANA.md — missing sections: Summary,Timeline,Chord Vocabulary,Theoretical Notes,Connections
...
| 2 | R14 | 13 |
| 3 | R01, R02, R03, R04, R08, R_BODY | 1 |
