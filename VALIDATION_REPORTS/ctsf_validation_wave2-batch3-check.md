...
**Generated:** 2026-04-24T17:08:29
**Source folder:** `02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 158 / 6252 — **2.53%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6085 / 6252 — 97.33%
- **Failed** (at least one Required rule fails): 9 / 6252 — 0.14%

- Schema-compliant (enriched + skeleton): 6243 / 6252 (99.86%)
...
| `R16` | mode-change separator uses ' / ' (lowercase mode) | 6250 | 2 | 100.0% |
...
| `REC_chapters` | recommended field 'chapters' populated | 272 | 5980 | 4.4% |
...
| `REC_form` | recommended field 'form' populated | 164 | 6088 | 2.6% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 163 | 6089 | 2.6% |
| `REC_tags` | recommended field 'tags' populated | 164 | 6088 | 2.6% |
| `REC_tempo` | recommended field 'tempo' populated | 163 | 6089 | 2.6% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 163 | 6089 | 2.6% |
