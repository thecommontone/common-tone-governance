...
**Generated:** 2026-04-24T09:28:53
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6252

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 57 / 6252 — **0.91%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6189 / 6252 — 98.99%
...
| `R14` | every form value maps to a Timeline header (suffix-stripped) | 6249 | 3 | 100.0% |
...
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 690 | 5562 | 11.0% |
| `REC_chapters` | recommended field 'chapters' populated | 59 | 6193 | 0.9% |
...
| `REC_form` | recommended field 'form' populated | 60 | 6192 | 1.0% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 59 | 6193 | 0.9% |
| `REC_tags` | recommended field 'tags' populated | 60 | 6192 | 1.0% |
| `REC_tempo` | recommended field 'tempo' populated | 59 | 6193 | 0.9% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 59 | 6193 | 0.9% |
...
- PINK_FLOYD - COMFORTABLY_NUMB.md — form values without Timeline header: ['bridge', 'chorus', 'solo', 'verse']
- PINK_FLOYD - SHINE_ON_YOU_CRAZY_DIAMOND.md — form values without Timeline header: ['interlude', 'intro', 'solo', 'theme-a', 'theme-b']
