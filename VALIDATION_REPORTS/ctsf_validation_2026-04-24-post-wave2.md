...
**Generated:** 2026-04-24T09:31:15
**Source folder:** `/sessions/gracious-peaceful-brown/mnt/__MY_BOOK/The_Common_Tone_Project/02_SOURCE_MATERIAL/REPERTOIRE`
**Files scanned:** 6251

## Headline

- **Enriched** (schema-compliant AND no `unknown` placeholders): 59 / 6251 — **0.94%**
- **Skeleton** (schema-compliant, but one or more Required fields is `unknown`): 6188 / 6251 — 98.99%
- **Failed** (at least one Required rule fails): 4 / 6251 — 0.06%

- Schema-compliant (enriched + skeleton): 6247 / 6251 (99.94%)
- Frontmatter parseable: 6251 / 6251 (100.0%)

## Required Rules — pass/fail breakdown

| Rule | Name | Pass | Fail | Pass % |
|---|---|---:|---:|---:|
| `R01` | ct_format field present in frontmatter | 6248 | 3 | 100.0% |
| `R02` | required fields present (song, artist, year, tonic, mode, meter) | 6248 | 3 | 100.0% |
| `R03` | tonic is letter name (A-G with optional ♭/♯) or `unknown` | 6248 | 3 | 100.0% |
| `R04` | mode is valid value, lowercase, or `unknown` | 6248 | 3 | 100.0% |
| `R05` | Timeline uses ♭/♯ not ASCII b/# | 6251 | 0 | 100.0% |
| `R07` | section headers well-formed (brackets optional) | 6251 | 0 | 100.0% |
| `R08` | filename follows §1.1 CTSF convention | 6248 | 3 | 100.0% |
| `R14` | every form value maps to a Timeline header (suffix-stripped) | 6250 | 1 | 100.0% |
| `R15` | tempo field value is a quoted string | 6251 | 0 | 100.0% |
| `R16` | mode-change separator uses ' / ' (lowercase mode) | 6251 | 0 | 100.0% |
| `R_BODY` | all required body sections present | 6248 | 3 | 100.0% |
| `R_TITLE` | # Title heading present | 6251 | 0 | 100.0% |

## Recommended Rules — pass/fail breakdown

| Rule | Field | Populated | Empty | Pass % |
|---|---|---:|---:|---:|
| `REC_album` | recommended field 'album' populated | 690 | 5561 | 11.0% |
| `REC_chapters` | recommended field 'chapters' populated | 59 | 6192 | 0.9% |
| `REC_ct_entry_date` | recommended field 'ct_entry_date' populated | 6248 | 3 | 100.0% |
| `REC_ct_last_updated` | recommended field 'ct_last_updated' populated | 6248 | 3 | 100.0% |
| `REC_form` | recommended field 'form' populated | 60 | 6191 | 1.0% |
| `REC_source_confidence` | recommended field 'source_confidence' populated | 59 | 6192 | 0.9% |
| `REC_tags` | recommended field 'tags' populated | 60 | 6191 | 1.0% |
| `REC_tempo` | recommended field 'tempo' populated | 59 | 6192 | 0.9% |
| `REC_tempo_feel` | recommended field 'tempo_feel' populated | 59 | 6192 | 0.9% |
...
- JOHNNY_CASH - I_WALK_THE_LINE.md — form values without Timeline header: ['verse']
