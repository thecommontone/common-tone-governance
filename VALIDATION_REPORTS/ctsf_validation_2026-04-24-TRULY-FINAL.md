...
- AL_GREEN - IM_STILL_IN_LOVE_WITH_YOU.md — form values without Timeline header: ['chorus', 'bridge', 'verse', 'intro', 'chorus-out']
- AL_GREEN - TAKE_ME_TO_THE_RIVER.md — form values without Timeline header: ['chorus', 'bridge', 'verse', 'intro', 'chorus-out']
- ANDRAE_CROUCH - THROUGH_IT_ALL.md — form values without Timeline header: ['chorus', 'verse']
- BILL_WITHERS - USE_ME.md — form values without Timeline header: ['chorus', 'bridge', 'verse', 'intro', 'chorus-out']
- CURTIS_MAYFIELD - MOVE_ON_UP.md — form values without Timeline header: ['chorus', 'instrumental-break', 'verse', 'intro', 'chorus-out']
